...
def load(cls, command_line_properties_file_path=None):
    ...
    1 - The user's home directory: ~/.%(project_name)s/server.properties
    ...
    properties_file_name = 'server.properties'
    properties_file_paths.append(os.path.join('/', 'etc', '%(project_name)s', properties_file_name))
    properties_file_paths.append(os.path.join(os.path.expanduser('~'), '.%(project_name)s', properties_file_name))
