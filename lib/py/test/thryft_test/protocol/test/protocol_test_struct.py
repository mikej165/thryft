...
class ProtocolTestStruct(object):
    ...
    def __hash__(self):
        return hash((self.bool_field,self.byte_field,self.date_field,self.date_time_field,self.decimal_field,self.enum_field,self.i16_field,self.i32_field,self.i64_field,self.list_string_field,self.map_string_string_field,self.set_string_field,self.string_field,self.struct_field,))
    ...
    def replace(self, bool_field=None, byte_field=None, date_field=None, date_time_field=None, decimal_field=None, enum_field=None, i16_field=None, i32_field=None, i64_field=None, list_string_field=None, map_string_string_field=None, set_string_field=None, string_field=None, struct_field=None):
        ...
        return self.__class__(bool_field=bool_field, byte_field=byte_field, date_field=date_field, date_time_field=date_time_field, decimal_field=decimal_field, enum_field=enum_field, i16_field=i16_field, i32_field=i32_field, i64_field=i64_field, list_string_field=list_string_field, map_string_string_field=map_string_string_field, set_string_field=set_string_field, string_field=string_field, struct_field=struct_field)
