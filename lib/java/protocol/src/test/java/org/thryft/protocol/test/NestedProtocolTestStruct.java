...
public class NestedProtocolTestStruct implements org.thryft.Base<NestedProtocolTestStruct> {
    ...
    public NestedProtocolTestStruct(final org.thryft.protocol.InputProtocol iprot) throws java.io.IOException {
        this(iprot, org.thryft.protocol.Type.STRUCT);
    }

    public NestedProtocolTestStruct(final org.thryft.protocol.InputProtocol iprot, final byte readAsTType) throws java.io.IOException {
    ...
    public void write(final org.thryft.protocol.OutputProtocol oprot, final byte writeAsTType) throws java.io.IOException {
        switch (writeAsTType) {
            ...
            case org.thryft.protocol.Type.LIST:
                oprot.writeListBegin(new org.thryft.protocol.ListBegin(org.thryft.protocol.Type.VOID, 17));
            ...
            case org.thryft.protocol.Type.STRUCT:
            default:
                oprot.writeStructBegin(new org.thryft.protocol.StructBegin("NestedProtocolTestStruct"));
                ...
                if (getByteField().isPresent()) {
                    oprot.writeFieldBegin(new org.thryft.protocol.FieldBegin("byte_field", org.thryft.protocol.Type.BYTE, (short)-1));
                    oprot.writeByte(getByteField().get());
                    oprot.writeFieldEnd();
                }
