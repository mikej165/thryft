...
public:
  ...
  ProtocolTestStruct(const int32_t& required_i32_field, const ::std::string& required_string_field, const ::thryft::Optional< ::std::string >& binary_field, const ::thryft::Optional< bool >& bool_field, const ::thryft::Optional< ::thryft::native::DateTime >& date_time_field, const ::thryft::Optional< ::thryft::native::Decimal >& decimal_field, const ::thryft::Optional< double >& double_field, const ::thryft::Optional< ::thryft::native::EmailAddress >& email_address_field, const ::thryft::Optional< ::thryft_test::protocol::test::ProtocolTestEnum >& enum_field, const ::thryft::Optional< float >& float_field, const ::thryft::Optional< int16_t >& i16_field, const ::thryft::Optional< int32_t >& i32_field, const ::thryft::Optional< int64_t >& i64_field, const ::thryft::Optional< int8_t >& i8_field, const ::thryft::Optional< ::std::string >& string_field, const ::thryft::Optional< ::thryft::List< ::std::string, ::thryft::protocol::Type::STRING > >& string_list_field, const ::thryft::Optional< ::thryft::Set< ::std::string, ::thryft::protocol::Type::STRING > >& string_set_field, const ::thryft::Optional< ::thryft::Map< ::std::string, ::thryft::protocol::Type::STRING, ::std::string, ::thryft::protocol::Type::STRING > >& string_string_map_field, const ::thryft::Optional< ::thryft_test::protocol::test::NestedProtocolTestStruct >& struct_field, const ::thryft::Optional< uint32_t >& u32_field, const ::thryft::Optional< uint64_t >& u64_field, const ::thryft::Optional< ::std::string >& uri_field, const ::thryft::Optional< ::std::string >& url_field, const ::thryft::Optional< ::thryft::native::Variant >& variant_field)
    : required_i32_field_(required_i32_field), required_string_field_(required_string_field), binary_field_(binary_field), bool_field_(bool_field), date_time_field_(date_time_field), decimal_field_(decimal_field), double_field_(double_field), email_address_field_(email_address_field), enum_field_(enum_field), float_field_(float_field), i16_field_(i16_field), i32_field_(i32_field), i64_field_(i64_field), i8_field_(i8_field), string_field_(string_field), string_list_field_(string_list_field), string_set_field_(string_set_field), string_string_map_field_(string_string_map_field), struct_field_(struct_field), u32_field_(u32_field), u64_field_(u64_field), uri_field_(uri_field), url_field_(url_field), variant_field_(variant_field) {
  }
  ...
  ::std::unique_ptr<ProtocolTestStruct> clone() const {
    return ::std::unique_ptr< ProtocolTestStruct >(new ProtocolTestStruct(required_i32_field_, required_string_field_, binary_field_, bool_field_, date_time_field_, decimal_field_, double_field_, email_address_field_, enum_field_, float_field_, i16_field_, i32_field_, i64_field_, i8_field_, string_field_, string_list_field_, string_set_field_, string_string_map_field_, struct_field_, u32_field_, u64_field_, uri_field_, url_field_, variant_field_));
  }
  ...
  ::thryft::Optional< double >& double_field() {
    return double_field_;
  }

  const ::thryft::Optional< double >& double_field() const {
    return double_field_;
  }
  ...
  ::thryft::Optional< float >& float_field() {
    return float_field_;
  }

  const ::thryft::Optional< float >& float_field() const {
    return float_field_;
  }
  ...
  bool operator==(const ProtocolTestStruct& other) const {
    ...
    if (!(double_field() == other.double_field())) {
      return false;
    }
    ...
    if (!(float_field() == other.float_field())) {
      return false;
    }
    ...
    if (!(variant_field() == other.variant_field())) {
      return false;
    }
  ...
  void read(::thryft::protocol::InputProtocol& iprot, const ::thryft::protocol::Type& as_type) {
    switch (static_cast< ::thryft::protocol::Type::Enum >(as_type)) {
      case ::thryft::protocol::Type::LIST: {
        ...
        if (list_size > 6) {
          double_field_ = iprot.read_double();
        }
        if (list_size > 7) {
        ...
        if (list_size > 9) {
          float_field_ = static_cast<float>(iprot.read_double());
        }
        if (list_size > 10) {
        ...
        if (list_size > 21) {
          uri_field_ = iprot.read_string();
        }
        if (list_size > 22) {
          url_field_ = iprot.read_string();
        }
        if (list_size > 23) {
          variant_field_ = iprot.read_variant();
        }
        iprot.read_list_end();
        break;
      }
      ...
      default: {
        ...
        for (;;) {
          ...
          if (ifield_type == ::thryft::protocol::Type::STOP) {
            ...
            u64_field_ = iprot.read_u64();
          } else if (ifield_name == "uri_field") {
            uri_field_ = iprot.read_string();
          } else if (ifield_name == "url_field") {
            url_field_ = iprot.read_string();
          } else if (ifield_name == "variant_field") {
            variant_field_ = iprot.read_variant();
          }
  ...
  ProtocolTestStruct& set_double_field(const ::thryft::Optional< double >& double_field) {
    this->double_field_ = double_field;
    return *this;
  }

  ProtocolTestStruct& set_double_field(const double& double_field) {
    return set_double_field(::thryft::Optional< double >(double_field));
  }
  ...
  ProtocolTestStruct& set_email_address_field(const ::thryft::native::EmailAddress& email_address_field) {
  ...
  ProtocolTestStruct& set_float_field(const ::thryft::Optional< float >& float_field) {
    this->float_field_ = float_field;
    return *this;
  }

  ProtocolTestStruct& set_float_field(const float& float_field) {
    return set_float_field(::thryft::Optional< float >(float_field));
  }
  ...
  ProtocolTestStruct& set_uri_field(const ::thryft::Optional< ::std::string >& uri_field) {
    this->uri_field_ = uri_field;
    return *this;
  }

  ProtocolTestStruct& set_uri_field(const ::std::string& uri_field) {
    return set_uri_field(::thryft::Optional< ::std::string >(uri_field));
  }
  ...
  ProtocolTestStruct& set_variant_field(const ::thryft::Optional< ::thryft::native::Variant >& variant_field) {
    this->variant_field_ = variant_field;
    return *this;
  }

  ProtocolTestStruct& set_variant_field(const ::thryft::native::Variant& variant_field) {
    return set_variant_field(::thryft::Optional< ::thryft::native::Variant >(variant_field));
  }
  ...
  ::thryft::Optional< ::std::string >& uri_field() {
    return uri_field_;
  }

  const ::thryft::Optional< ::std::string >& uri_field() const {
    return uri_field_;
  }
  ...
  ::thryft::Optional< ::thryft::native::Variant >& variant_field() {
    return variant_field_;
  }

  const ::thryft::Optional< ::thryft::native::Variant >& variant_field() const {
    return variant_field_;
  }
  ...
  void write(::thryft::protocol::OutputProtocol& oprot, const ::thryft::protocol::Type& as_type) const {
    ...
    case ::thryft::protocol::Type::LIST:
      oprot.write_list_begin(::thryft::protocol::Type::VOID_, 24);
      ...
      if (double_field().present()) {
          oprot.write(double_field().get());
      } else {
          oprot.write_null();
      }
    ...
    default:
      ...
      if (double_field().present()) {
          oprot.write_field_begin("double_field", ::thryft::protocol::Type::DOUBLE, static_cast<int16_t>(7));
          oprot.write(double_field().get());
          oprot.write_field_end();
      }

      if (email_address_field().present()) {
          oprot.write_field_begin("email_address_field", ::thryft::protocol::Type::STRING, static_cast<int16_t>(8));
          oprot.write(email_address_field().get());
          oprot.write_field_end();
      }

      if (enum_field().present()) {
          oprot.write_field_begin("enum_field", ::thryft::protocol::Type::STRING, static_cast<int16_t>(9));
          enum_field().get().write(oprot);
          oprot.write_field_end();
      }

      if (float_field().present()) {
          oprot.write_field_begin("float_field", ::thryft::protocol::Type::DOUBLE, static_cast<int16_t>(10));
          oprot.write(float_field().get());
          oprot.write_field_end();
      }

      if (i16_field().present()) {
          oprot.write_field_begin("i16_field", ::thryft::protocol::Type::I16, static_cast<int16_t>(12));
          oprot.write(i16_field().get());
          oprot.write_field_end();
      }

      if (i32_field().present()) {
          oprot.write_field_begin("i32_field", ::thryft::protocol::Type::I32, static_cast<int16_t>(13));
          oprot.write(i32_field().get());
          oprot.write_field_end();
      }

      if (i64_field().present()) {
          oprot.write_field_begin("i64_field", ::thryft::protocol::Type::I64, static_cast<int16_t>(14));
          oprot.write(i64_field().get());
          oprot.write_field_end();
      }

      if (i8_field().present()) {
          oprot.write_field_begin("i8_field", ::thryft::protocol::Type::BYTE, static_cast<int16_t>(11));
          oprot.write(i8_field().get());
          oprot.write_field_end();
      }

      if (string_field().present()) {
          oprot.write_field_begin("string_field", ::thryft::protocol::Type::STRING, static_cast<int16_t>(18));
          oprot.write(string_field().get());
          oprot.write_field_end();
      }

      if (string_list_field().present()) {
          oprot.write_field_begin("string_list_field", ::thryft::protocol::Type::LIST, static_cast<int16_t>(15));
          oprot.write(string_list_field().get());
          oprot.write_field_end();
      }

      if (string_set_field().present()) {
          oprot.write_field_begin("string_set_field", ::thryft::protocol::Type::SET, static_cast<int16_t>(17));
          oprot.write(string_set_field().get());
          oprot.write_field_end();
      }

      if (string_string_map_field().present()) {
          oprot.write_field_begin("string_string_map_field", ::thryft::protocol::Type::MAP, static_cast<int16_t>(16));
          oprot.write(string_string_map_field().get());
          oprot.write_field_end();
      }

      if (struct_field().present()) {
          oprot.write_field_begin("struct_field", ::thryft::protocol::Type::STRUCT, static_cast<int16_t>(19));
          oprot.write(struct_field().get());
          oprot.write_field_end();
      }

      if (u32_field().present()) {
          oprot.write_field_begin("u32_field", ::thryft::protocol::Type::I32, static_cast<int16_t>(20));
          oprot.write(u32_field().get());
          oprot.write_field_end();
      }

      if (u64_field().present()) {
          oprot.write_field_begin("u64_field", ::thryft::protocol::Type::I64, static_cast<int16_t>(21));
          oprot.write(u64_field().get());
          oprot.write_field_end();
      }

      if (uri_field().present()) {
          oprot.write_field_begin("uri_field", ::thryft::protocol::Type::STRING, static_cast<int16_t>(22));
          oprot.write(uri_field().get());
          oprot.write_field_end();
      }

      if (url_field().present()) {
          oprot.write_field_begin("url_field", ::thryft::protocol::Type::STRING, static_cast<int16_t>(23));
          oprot.write(url_field().get());
          oprot.write_field_end();
      }

      if (variant_field().present()) {
          oprot.write_field_begin("variant_field", ::thryft::protocol::Type::STRUCT, static_cast<int16_t>(24));
          oprot.write(variant_field().get());
          oprot.write_field_end();
      }
...
private:
  ...
  ::thryft::Optional< double > double_field_;
  ...
  ::thryft::Optional< ::std::string > uri_field_;
  ::thryft::Optional< ::std::string > url_field_;
  ::thryft::Optional< ::thryft::native::Variant > variant_field_;
};
}
}
}
