...
class ProtocolTestStruct : public ::thryft::Struct {
  public:
    ...
    ProtocolTestStruct(::thryft::protocol::InputProtocol& iprot,
                       ::thryft::protocol::Type::Enum as_type) {
      read(iprot, as_type);
    }

    ProtocolTestStruct(const int32_t& required_i32_field,
                       const ::std::string& required_string_field)
      : required_i32_field_(required_i32_field),
        required_string_field_(required_string_field) {
    }

    ProtocolTestStruct(const ::thryft::Optional< ::std::string >& binary_field,
                       const ::thryft::Optional< bool >& bool_field,
                       const ::thryft::Optional< int8_t >& byte_field,
                       const ::thryft::Optional< int64_t >& date_time_field,
                       const ::thryft::Optional< ::std::string >& decimal_field,
                       const ::thryft::Optional< ::std::string >& email_address_field,
                       const ::thryft::Optional< ::thryft_test::protocol::test::ProtocolTestEnum::Enum >&
                       enum_field, const ::thryft::Optional< int16_t >& i16_field,
                       const ::thryft::Optional< int32_t >& i32_field,
                       const ::thryft::Optional< int64_t >& i64_field,
                       const ::thryft::Optional< ::thryft::List< ::std::string, ::thryft::protocol::Type::STRING > >&
                       list_string_field,
                       const ::thryft::Optional< ::thryft::Map< ::std::string, ::thryft::protocol::Type::STRING, ::std::string, ::thryft::protocol::Type::STRING > >&
                       map_string_string_field, const int32_t& required_i32_field,
                       const ::std::string& required_string_field,
                       const ::thryft::Optional< ::thryft::Set< ::std::string, ::thryft::protocol::Type::STRING > >&
                       set_string_field, const ::thryft::Optional< ::std::string >& string_field,
                       const ::thryft::Optional< ::thryft_test::protocol::test::NestedProtocolTestStruct >&
                       struct_field, const ::thryft::Optional< ::std::string >& url_field)
      : binary_field_(binary_field), bool_field_(bool_field), byte_field_(byte_field),
        date_time_field_(date_time_field), decimal_field_(decimal_field),
        email_address_field_(email_address_field), enum_field_(enum_field),
        i16_field_(i16_field), i32_field_(i32_field), i64_field_(i64_field),
        list_string_field_(list_string_field),
        map_string_string_field_(map_string_string_field),
        required_i32_field_(required_i32_field),
        required_string_field_(required_string_field),
        set_string_field_(set_string_field), string_field_(string_field),
        struct_field_(struct_field), url_field_(url_field) {
    }
    ...
    const ::thryft::Optional< ::thryft::List< ::std::string, ::thryft::protocol::Type::STRING > >&
    list_string_field() const {
      return list_string_field_;
    }

    const ::thryft::Optional< ::thryft::Map< ::std::string, ::thryft::protocol::Type::STRING, ::std::string, ::thryft::protocol::Type::STRING > >&
    map_string_string_field() const {
    ...
    ProtocolTestStruct& set_binary_field(const ::thryft::Optional< ::std::string >&
                                         binary_field) {
    ...
    ProtocolTestStruct& set_bool_field(const ::thryft::Optional< bool >&
                                       bool_field) {
    ...
    ProtocolTestStruct& set_byte_field(const ::thryft::Optional< int8_t >&
                                       byte_field) {
    ...
    ProtocolTestStruct& set_date_time_field(const ::thryft::Optional< int64_t >&
                                            date_time_field) {
    ...
    ProtocolTestStruct& set_decimal_field(const ::thryft::Optional< ::std::string >&
                                          decimal_field) {
    ...
    ProtocolTestStruct& set_email_address_field(
      const ::thryft::Optional< ::std::string >& email_address_field) {
      this->email_address_field_ = email_address_field;
      return *this;
    }

    ProtocolTestStruct& set_email_address_field(const ::std::string&
        email_address_field) {
      return set_email_address_field(::thryft::Optional< ::std::string >
                                     (email_address_field));
    }

    ProtocolTestStruct& set_enum_field(
      const ::thryft::Optional< ::thryft_test::protocol::test::ProtocolTestEnum::Enum >&
      enum_field) {
    ...
    ProtocolTestStruct& set_enum_field(
      const ::thryft_test::protocol::test::ProtocolTestEnum::Enum& enum_field) {
      return set_enum_field(
               ::thryft::Optional< ::thryft_test::protocol::test::ProtocolTestEnum::Enum >
               (enum_field));
    }

    ProtocolTestStruct& set_i16_field(const ::thryft::Optional< int16_t >&
                                      i16_field) {
    ...
    ProtocolTestStruct& set_i32_field(const ::thryft::Optional< int32_t >&
                                      i32_field) {
    ...
    ProtocolTestStruct& set_i64_field(const ::thryft::Optional< int64_t >&
                                      i64_field) {
    ...
    ProtocolTestStruct& set_list_string_field(
      const ::thryft::Optional< ::thryft::List< ::std::string, ::thryft::protocol::Type::STRING > >&
      list_string_field) {
    ...
    ProtocolTestStruct& set_list_string_field(
      const ::thryft::List< ::std::string, ::thryft::protocol::Type::STRING >&
      list_string_field) {
      return set_list_string_field(
               ::thryft::Optional< ::thryft::List< ::std::string, ::thryft::protocol::Type::STRING > >
               (list_string_field));
    }

    ProtocolTestStruct& set_map_string_string_field(
      const ::thryft::Optional< ::thryft::Map< ::std::string, ::thryft::protocol::Type::STRING, ::std::string, ::thryft::protocol::Type::STRING > >&
    ...
    ProtocolTestStruct& set_map_string_string_field(
      const ::thryft::Map< ::std::string, ::thryft::protocol::Type::STRING, ::std::string, ::thryft::protocol::Type::STRING >&
      map_string_string_field) {
      return set_map_string_string_field(
               ::thryft::Optional< ::thryft::Map< ::std::string, ::thryft::protocol::Type::STRING, ::std::string, ::thryft::protocol::Type::STRING > >
               (map_string_string_field));
    }
    ...
    ProtocolTestStruct& set_required_string_field(const ::std::string&
        required_string_field) {
      this->required_string_field_ = required_string_field;
      return *this;
    }

    ProtocolTestStruct& set_set_string_field(
      const ::thryft::Optional< ::thryft::Set< ::std::string, ::thryft::protocol::Type::STRING > >&
      set_string_field) {
    ...
    ProtocolTestStruct& set_set_string_field(
      const ::thryft::Set< ::std::string, ::thryft::protocol::Type::STRING >&
      set_string_field) {
      return set_set_string_field(
               ::thryft::Optional< ::thryft::Set< ::std::string, ::thryft::protocol::Type::STRING > >
               (set_string_field));
    }

    ProtocolTestStruct& set_string_field(const ::thryft::Optional< ::std::string >&
                                         string_field) {
    ...
    ProtocolTestStruct& set_struct_field(
      const ::thryft::Optional< ::thryft_test::protocol::test::NestedProtocolTestStruct >&
      struct_field) {
    ...
    ProtocolTestStruct& set_struct_field(
      const ::thryft_test::protocol::test::NestedProtocolTestStruct& struct_field) {
      return set_struct_field(
               ::thryft::Optional< ::thryft_test::protocol::test::NestedProtocolTestStruct >
               (struct_field));
    }

    ProtocolTestStruct& set_url_field(const ::thryft::Optional< ::std::string >&
                                      url_field) {
    ...
    void read(::thryft::protocol::InputProtocol& iprot,
      ...
      case ::thryft::protocol::Type::LIST: {
        ...
        list_string_field_.set(
          ::thryft::List< ::std::string, ::thryft::protocol::Type::STRING >())->read(
            iprot);
        map_string_string_field_.set(
          ::thryft::Map< ::std::string, ::thryft::protocol::Type::STRING, ::std::string, ::thryft::protocol::Type::STRING >())->read(
            iprot);
        required_i32_field_ = iprot.read_i32();
        iprot.read_string(required_string_field_);
        if (list_size > 14) {
          set_string_field_.set(
            ::thryft::Set< ::std::string, ::thryft::protocol::Type::STRING >())->read(
              iprot);
        }
        if (list_size > 15) {
        ...
        if (list_size > 16) {
          struct_field_.set(
            ::thryft_test::protocol::test::NestedProtocolTestStruct())->read(iprot);
        }
        if (list_size > 17) {
    ...
    void write(::thryft::protocol::OutputProtocol& oprot,
               ::thryft::protocol::Type::Enum as_type) const {
      switch (as_type) {
      case ::thryft::protocol::Type::VOID:
      case ::thryft::protocol::Type::LIST:
        oprot.write_list_begin(::thryft::protocol::Type::VOID, 18);
        ...
        if (enum_field().present()) {
          ::thryft_test::protocol::test::ProtocolTestEnum::write(oprot,
              enum_field().get());
        } else {
          oprot.write_null();
        }
      ...
      default:
        ...
        if (binary_field().present()) {
          oprot.write_field_begin("binary_field", ::thryft::protocol::Type::STRING,
        ...
        if (bool_field().present()) {
          oprot.write_field_begin("bool_field", ::thryft::protocol::Type::BOOL,
                                  static_cast<int16_t>(-1));
          oprot.write(bool_field().get());
          oprot.write_field_end();
        }
        ...
        if (byte_field().present()) {
          oprot.write_field_begin("byte_field", ::thryft::protocol::Type::BYTE,
                                  static_cast<int16_t>(-1));
          oprot.write(byte_field().get());
          oprot.write_field_end();
        }
        ...
        if (date_time_field().present()) {
          oprot.write_field_begin("date_time_field", ::thryft::protocol::Type::I64,
                                  static_cast<int16_t>(-1));
          oprot.write(date_time_field().get());
          oprot.write_field_end();
        }
        ...
        if (decimal_field().present()) {
          oprot.write_field_begin("decimal_field", ::thryft::protocol::Type::STRING,
                                  static_cast<int16_t>(-1));
          oprot.write(decimal_field().get());
          oprot.write_field_end();
        }
        ...
        if (email_address_field().present()) {
          oprot.write_field_begin("email_address_field", ::thryft::protocol::Type::STRING,
                                  static_cast<int16_t>(-1));
          oprot.write(email_address_field().get());
          oprot.write_field_end();
        }
        ...
        if (enum_field().present()) {
          oprot.write_field_begin("enum_field", ::thryft::protocol::Type::STRING,
                                  static_cast<int16_t>(-1));
          ::thryft_test::protocol::test::ProtocolTestEnum::write(oprot,
              enum_field().get());
          oprot.write_field_end();
        ...
        if (i16_field().present()) {
          oprot.write_field_begin("i16_field", ::thryft::protocol::Type::I16,
                                  static_cast<int16_t>(-1));
          oprot.write(i16_field().get());
          oprot.write_field_end();
        }
        ...
        if (i32_field().present()) {
          oprot.write_field_begin("i32_field", ::thryft::protocol::Type::I32,
                                  static_cast<int16_t>(-1));
          oprot.write(i32_field().get());
          oprot.write_field_end();
        }
        ...
        if (i64_field().present()) {
          oprot.write_field_begin("i64_field", ::thryft::protocol::Type::I64,
                                  static_cast<int16_t>(-1));
          oprot.write(i64_field().get());
          oprot.write_field_end();
        }
        ...
        if (list_string_field().present()) {
          oprot.write_field_begin("list_string_field", ::thryft::protocol::Type::LIST,
                                  static_cast<int16_t>(-1));
          oprot.write(list_string_field().get());
          oprot.write_field_end();
        }
        ...
        if (map_string_string_field().present()) {
          oprot.write_field_begin("map_string_string_field",
                                  ::thryft::protocol::Type::MAP, static_cast<int16_t>(-1));
          oprot.write(map_string_string_field().get());
          oprot.write_field_end();
        }

        oprot.write_field_begin("required_i32_field", ::thryft::protocol::Type::I32,
                                static_cast<int16_t>(-1));
        oprot.write(required_i32_field());
        oprot.write_field_end();

        oprot.write_field_begin("required_string_field",
                                ::thryft::protocol::Type::STRING, static_cast<int16_t>(-1));
        oprot.write(required_string_field());
        oprot.write_field_end();

        if (set_string_field().present()) {
          oprot.write_field_begin("set_string_field", ::thryft::protocol::Type::SET,
                                  static_cast<int16_t>(-1));
          oprot.write(set_string_field().get());
          oprot.write_field_end();
        }
        ...
        if (string_field().present()) {
          oprot.write_field_begin("string_field", ::thryft::protocol::Type::STRING,
                                  static_cast<int16_t>(-1));
          oprot.write(string_field().get());
          oprot.write_field_end();
        }
        ...
        if (struct_field().present()) {
          oprot.write_field_begin("struct_field", ::thryft::protocol::Type::STRUCT,
                                  static_cast<int16_t>(-1));
          oprot.write(struct_field().get());
          oprot.write_field_end();
        }
        ...
        if (url_field().present()) {
          oprot.write_field_begin("url_field", ::thryft::protocol::Type::STRING,
                                  static_cast<int16_t>(-1));
          oprot.write(url_field().get());
          oprot.write_field_end();
        }
