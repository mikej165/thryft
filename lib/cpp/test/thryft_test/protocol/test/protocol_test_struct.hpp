...
#include "thryft_test/protocol/test/protocol_test_struct.hpp"
#include "thryft/native/url.hpp"
...
public:
  ProtocolTestStruct()
    : bool_field_(false), byte_field_(static_cast<int8_t>(0)), enum_field_(::thryft_test::protocol::test::ProtocolTestEnum::ENUMERATOR1), i16_field_(static_cast<int16_t>(0)), i32_field_(static_cast<int32_t>(0)), i64_field_(static_cast<int64_t>(0)), required_i32_field_(static_cast<int32_t>(0)) {
  }
  ...
  ProtocolTestStruct(const int32_t& required_i32_field, const ::std::string& required_string_field)
    : bool_field_(false), byte_field_(static_cast<int8_t>(0)), enum_field_(::thryft_test::protocol::test::ProtocolTestEnum::ENUMERATOR1), i16_field_(static_cast<int16_t>(0)), i32_field_(static_cast<int32_t>(0)), i64_field_(static_cast<int64_t>(0)), required_i32_field_(required_i32_field), required_string_field_(required_string_field) {
  }

  ProtocolTestStruct(const ::thryft::Optional< binary >& binary_field, const ::thryft::Optional< bool >& bool_field, const ::thryft::Optional< int8_t >& byte_field, const ::thryft::Optional< ::thryft::native::DateTime >& date_time_field, const ::thryft::Optional< ::thryft::native::Decimal >& decimal_field, const ::thryft::Optional< ::thryft::native::EmailAddress >& email_address_field, const ::thryft::Optional< ::thryft_test::protocol::test::ProtocolTestEnum::Enum >& enum_field, const ::thryft::Optional< int16_t >& i16_field, const ::thryft::Optional< int32_t >& i32_field, const ::thryft::Optional< int64_t >& i64_field, const ::thryft::Optional< ::thryft::List< ::std::string, ::thryft::protocol::Protocol::Type::STRING > >& list_string_field, const ::thryft::Optional< ::thryft::Map< ::std::string, ::thryft::protocol::Protocol::Type::STRING, ::std::string, ::thryft::protocol::Protocol::Type::STRING > >& map_string_string_field, const int32_t& required_i32_field, const ::std::string& required_string_field, const ::thryft::Optional< ::thryft::Set< ::std::string, ::thryft::protocol::Protocol::Type::STRING > >& set_string_field, const ::thryft::Optional< ::std::string >& string_field, const ::thryft::Optional< ::thryft_test::protocol::test::ProtocolTestStruct >& struct_field, const ::thryft::Optional< ::thryft::native::Url >& url_field)
  ...
  const ::thryft::Optional< binary >& binary_field() const {
  ...
  void read(::thryft::protocol::Protocol& iprot, ::thryft::protocol::Protocol::Type::Enum as_type) {
    switch (as_type) {
      case ::thryft::protocol::Protocol::Type::LIST: {
        ...
        binary_field_ = iprot.read_binary();
        bool_field_ = iprot.read_bool();
        byte_field_ = iprot.read_byte();
        date_time_field_.read(iprot);
        decimal_field_.read(iprot);
        email_address_field_.read(iprot);
        ...
        list_string_field_.read(iprot);
        map_string_string_field_.read(iprot);
        required_i32_field_ = iprot.read_i32();
        iprot.read_string(required_string_field_);
        if (list_size > 14) {
          set_string_field_.read(iprot);
        }
        if (list_size > 15) {
          iprot.read_string(string_field_);
        }
        if (list_size > 16) {
          struct_field_.read(iprot);
        }
        if (list_size > 17) {
          url_field_.read(iprot);
        }
        iprot.read_list_end();
        break;
      }
  ...
  const ::thryft::Optional< ::thryft_test::protocol::test::ProtocolTestStruct >& struct_field() const {
    return struct_field_;
  }

  const ::thryft::Optional< ::thryft::native::Url >& url_field() const {
    return url_field_;
  }
  ...
  void write(::thryft::protocol::Protocol& oprot, ::thryft::protocol::Protocol::Type::Enum as_type) const {
    ...
    default:
      ...
      if (date_time_field().present()) {
          oprot.write_field_begin("date_time_field", ::thryft::protocol::Protocol::Type::STRUCT, static_cast<int16_t>(-1));
          oprot.write(date_time_field().get());
          oprot.write_field_end();
      }

      if (decimal_field().present()) {
          oprot.write_field_begin("decimal_field", ::thryft::protocol::Protocol::Type::STRUCT, static_cast<int16_t>(-1));
          oprot.write(decimal_field().get());
          oprot.write_field_end();
      }

      if (email_address_field().present()) {
          oprot.write_field_begin("email_address_field", ::thryft::protocol::Protocol::Type::STRUCT, static_cast<int16_t>(-1));
          oprot.write(email_address_field().get());
          oprot.write_field_end();
      }
      ...
      if (url_field().present()) {
          oprot.write_field_begin("url_field", ::thryft::protocol::Protocol::Type::STRUCT, static_cast<int16_t>(-1));
          oprot.write(url_field().get());
          oprot.write_field_end();
      }
...
private:
  ::thryft::Optional< binary > binary_field_;
  ...
  ::thryft::Optional< ::thryft_test::protocol::test::ProtocolTestStruct > struct_field_;
  ::thryft::Optional< ::thryft::native::Url > url_field_;
};
}
}
}
