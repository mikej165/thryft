...
class NestedProtocolTestStruct : public ::thryft::Struct {
  public:
    ...
    NestedProtocolTestStruct(const int32_t& required_i32_field,
                             const ::std::string& required_string_field)
      : required_i32_field_(required_i32_field),
        required_string_field_(required_string_field) {
    }

    NestedProtocolTestStruct(const ::thryft::Optional< ::std::string >&
                             binary_field, const ::thryft::Optional< bool >& bool_field,
                             ...
                             const ::thryft::Optional< ::std::string >& url_field)
    ...
    NestedProtocolTestStruct& set_binary_field(
      const ::thryft::Optional< ::std::string >& binary_field) {
    ...
    NestedProtocolTestStruct& set_bool_field(const ::thryft::Optional< bool >&
        bool_field) {
    ...
    NestedProtocolTestStruct& set_byte_field(const ::thryft::Optional< int8_t >&
        byte_field) {
    ...
    NestedProtocolTestStruct& set_date_time_field(
      const ::thryft::Optional< int64_t >& date_time_field) {
    ...
    NestedProtocolTestStruct& set_decimal_field(
      const ::thryft::Optional< ::std::string >& decimal_field) {
      this->decimal_field_ = decimal_field;
      return *this;
    }

    NestedProtocolTestStruct& set_decimal_field(const ::std::string&
        decimal_field) {
      return set_decimal_field(::thryft::Optional< ::std::string >(decimal_field));
    }

    NestedProtocolTestStruct& set_email_address_field(
      const ::thryft::Optional< ::std::string >& email_address_field) {
      this->email_address_field_ = email_address_field;
      return *this;
    }

    NestedProtocolTestStruct& set_email_address_field(const ::std::string&
        email_address_field) {
      return set_email_address_field(::thryft::Optional< ::std::string >
                                     (email_address_field));
    }

    NestedProtocolTestStruct& set_enum_field(
      const ::thryft::Optional< ::thryft_test::protocol::test::ProtocolTestEnum::Enum >&
      enum_field) {
    ...
    NestedProtocolTestStruct& set_i16_field(const ::thryft::Optional< int16_t >&
                                            i16_field) {
    ...
    NestedProtocolTestStruct& set_i32_field(const ::thryft::Optional< int32_t >&
                                            i32_field) {
    ...
    NestedProtocolTestStruct& set_i64_field(const ::thryft::Optional< int64_t >&
                                            i64_field) {
    ...
    NestedProtocolTestStruct& set_list_string_field(
      const ::thryft::Optional< ::thryft::List< ::std::string, ::thryft::protocol::Type::STRING > >&
      list_string_field) {
    ...
    NestedProtocolTestStruct& set_map_string_string_field(
      const ::thryft::Optional< ::thryft::Map< ::std::string, ::thryft::protocol::Type::STRING, ::std::string, ::thryft::protocol::Type::STRING > >&
    ...
    NestedProtocolTestStruct& set_required_i32_field(const int32_t&
        required_i32_field) {
      this->required_i32_field_ = required_i32_field;
      return *this;
    }

    NestedProtocolTestStruct& set_required_string_field(const ::std::string&
        required_string_field) {
      this->required_string_field_ = required_string_field;
      return *this;
    }

    NestedProtocolTestStruct& set_set_string_field(
      const ::thryft::Optional< ::thryft::Set< ::std::string, ::thryft::protocol::Type::STRING > >&
      set_string_field) {
    ...
    NestedProtocolTestStruct& set_string_field(
      const ::thryft::Optional< ::std::string >& string_field) {
    ...
    NestedProtocolTestStruct& set_url_field(
      const ::thryft::Optional< ::std::string >& url_field) {
    ...
    void write(::thryft::protocol::OutputProtocol& oprot,
      ...
      case ::thryft::protocol::Type::LIST:
        oprot.write_list_begin(::thryft::protocol::Type::VOID, 17);
