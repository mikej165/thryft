...
public:
  ...
  virtual void read_field_begin(std::string& out_name, Type::Enum& out_type, int16_t& out_id) = 0;
  ...
  virtual void read_list_begin(Type::Enum& out_element_type, uint32_t& out_size) = 0;
  virtual void read_list_end() = 0;
  virtual void read_map_begin(Type::Enum& out_key_type, Type::Enum& out_value_type, uint32_t& out_size) = 0;
  virtual void read_map_end() = 0;
  virtual void read_set_begin(Type::Enum& out_element_type, uint32_t& out_size) = 0;
  ...
  // Field
  virtual void write_field_begin(const char* name, Type::Enum type, int16_t id) = 0;
  ...
  virtual void write_map_begin(Type::Enum key_type, Type::Enum value_type, uint32_t size) = 0;
