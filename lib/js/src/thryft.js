...
thryft.core.protocol.BuiltinsProtocol.prototype = {
	...
	readStructBegin : function() {
		...
		this.scopeStack.push(new thryft.core.protocol.__BuiltinsProtocolStructScope(struct));
		return {};
	},
	...
	readMapBegin : function() {
		...
		this.scopeStack.push(new thryft.core.protocol.__BuiltinsProtocolMapScope(map));
		return {size: mapSize};
	},
	...
	readListBegin : function() {
		...
		this.scopeStack.push(new thryft.core.protocol.__BuiltinsProtocolListScope(list));
	...
	writeStructBegin : function(name) {
		this.scopeStack.push(new thryft.core.protocol.__BuiltinsProtocolStructScope());
	},

	writeStructEnd : function() {
		var structScope = this.scopeStack.pop();
		this.scopeStack[this.scopeStack.length - 1].writeValue(structScope.struct);
	},

	writeFieldBegin : function(name, fieldType, fieldId) {
		this.scopeStack[this.scopeStack.length - 1].writeFieldBegin(name, fieldType, fieldId);
	},
	...
	writeMapBegin : function(keyType, valType, size) {
		this.scopeStack.push(new thryft.core.protocol.__BuiltinsProtocolMapScope());
	},
	...
	writeListBegin : function(elemType, size) {
		this.scopeStack.push(new thryft.core.protocol.__BuiltinsProtocolListScope());
	},
