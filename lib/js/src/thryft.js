...
if (typeof thryft.protocol === "undefined") {
	thryft.protocol = new Object();
}

thryft.protocol.__BuiltinsProtocolListScope = function(input) {
...
thryft.protocol.__BuiltinsProtocolListScope.prototype = {
	readValue : function() {
...
thryft.protocol.__BuiltinsProtocolMapScope = function(input) {
	if (typeof input !== "undefined") {
...
thryft.protocol.__BuiltinsProtocolMapScope.prototype = {
	readValue : function() {
...
thryft.protocol.__BuiltinsProtocolStructScope = function(input) {
	if (typeof input !== "undefined") {
		...
		thryft.protocol.__BuiltinsProtocolStructScope.prototype = {
		...
		thryft.protocol.BuiltinsProtocol = function(input, inputIsMap) {
			this.scopeStack = [ new thryft.protocol.__BuiltinsProtocolListScope() ];
			if (typeof input !== "undefined") {
				this.scopeStack[this.scopeStack.length - 1].writeValue(input);
			}
		};

thryft.protocol.BuiltinsProtocol.prototype = {
	...
	readListBegin : function() {
		...
		this.scopeStack
				.push(new thryft.protocol.__BuiltinsProtocolListScope(list));
		return {
			size : list.length
		};
	},
	...
	readMapBegin : function() {
		...
		this.scopeStack
				.push(new thryft.protocol.__BuiltinsProtocolMapScope(map));
		return {
			size : mapSize
		};
	},
	...
	readStructBegin : function() {
		...
		this.scopeStack
				.push(new thryft.protocol.__BuiltinsProtocolStructScope(
						struct));
		return {};
	},
	...
	writeEmailAddress : function(emailAddress) {
		this.writeString(emailAddress);
	},
	...
	writeListBegin : function(elemType, size) {
		this.scopeStack
				.push(new thryft.protocol.__BuiltinsProtocolListScope());
	},
	...
	writeMapBegin : function(keyType, valType, size) {
		this.scopeStack
				.push(new thryft.protocol.__BuiltinsProtocolMapScope());
	},
