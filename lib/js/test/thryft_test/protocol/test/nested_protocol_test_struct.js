...
thryft_test.protocol.test.NestedProtocolTestStruct = Backbone.Model.extend(
    {
        ...
        validation: {
                ...
                "fn": function(value, attr, computedState) {
                    if (typeof attr !== "undefined" && attr !== "null") {
                        if (!Array.isArray(value)) {
                            return "expected thryft_test.protocol.test.NestedProtocolTestStruct.listStringField to be an Array";
                        }
                        for (var __i0 = 0; __i0 < value.length; __i0++) {
                            if (typeof value[__i0] !== "string") {
                                return "expected thryft_test.protocol.test.NestedProtocolTestStruct.listStringField[i] to be a string";
                            }
                        }
                    }
                },
                ...
                "fn": function(value, attr, computedState) {
                    if (typeof attr !== "undefined" && attr !== "null") {
                        if (typeof value !== "object") {
                            return "expected thryft_test.protocol.test.NestedProtocolTestStruct.mapStringStringField to be an object";
                        }
                        for (var __key0 in value) {
                            var __value0 = value[__key0];
                            if (typeof __key0 !== "string") {
                                return "expected thryft_test.protocol.test.NestedProtocolTestStruct.mapStringStringField key to be a string";
                            }
                            if (typeof __value0 !== "string") {
                                return "expected thryft_test.protocol.test.NestedProtocolTestStruct.mapStringStringField value to be a string";
                            }
                        }
                    }
                },
            ...
            setStringField: {
                "fn": function(value, attr, computedState) {
                    if (typeof attr !== "undefined" && attr !== "null") {
                        if (!Array.isArray(value)) {
                            return "expected thryft_test.protocol.test.NestedProtocolTestStruct.setStringField to be an Array";
                        }
                        for (var __i0 = 0; __i0 < value.length; __i0++) {
                            if (typeof value[__i0] !== "string") {
                                return "expected thryft_test.protocol.test.NestedProtocolTestStruct.setStringField[i] to be a string";
                            }
                        }
                    }
                },
        ...
        write: function(oprot) {
            ...
            if (this.has("urlField")) {
                ...
                oprot.writeUri(this.get("urlField"));
                oprot.writeFieldEnd();
            }
