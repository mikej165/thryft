...
thryft_test.protocol.test.ProtocolTestStruct = Backbone.Model.extend(
    {
        ...
        validation: {
            ...
            doubleField: {
                "fn": function(value, attr, computedState) {
                    if (typeof attr !== "undefined" && attr !== "null") {
                        if (typeof value !== "number") {
                            return "expected thryft_test.protocol.test.ProtocolTestStruct.doubleField to be a number";
                        }
                    }
                },
                "required": false
        ...
        write: function(oprot) {
            ...
            if (this.has("doubleField")) {
                oprot.writeFieldBegin("double_field");
                oprot.writeDouble(this.get("doubleField"));
                oprot.writeFieldEnd();
            }
    ...
    },
    {
        read: function(iprot) {
            ...
            while (true) {
                ...
                } else if (field.fname == "double_field") {
                    fields["doubleField"] = iprot.readDouble();
