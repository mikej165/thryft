...
thryft_test.core.protocol.test.ProtocolTestStruct = Backbone.Model.extend(
    {
        ...
        /** @type thryft_test.core.protocol.test.ProtocolTestEnum */
        enumField:undefined,
        /** @type number */
        i16Field:undefined,
        /** @type number */
        ...
        /** @type thryft_test.core.protocol.test.ProtocolTestStruct */
        ...
        schema: {
            ...
            "structField": {
                "model": thryft_test.core.protocol.test.ProtocolTestStruct,
                "type": "NestedModel"
            },
            "listStringField": {
                "type": "List",
        ...
        validation: {
            ...
            urlField: {
                "fn": function(value, attr, computedState) {
                    if (typeof value !== "string") {
                        return "expected thryft_test.core.protocol.test.ProtocolTestStruct.urlField to be a string";
                    }
                },
        ...
        write: function(oprot) {
            ...
            if (this.has("urlField")) {
                ...
                if (typeof oprot.writeUrl !== "undefined") { oprot.writeUrl(this.get("urlField")); } else { oprot.writeString(this.get("urlField")); }
                oprot.writeFieldEnd();
            }
        ...
        read: function(iprot) {
            ...
            while (true) {
                ...
                if (field.fname.length == 0) {
                    ...
                    fields["urlField"] = ((typeof iprot.readUrl !== "undefined") ? iprot.readUrl() : iprot.readString());
                }
                iprot.readFieldEnd();
            }
            iprot.readStructEnd();
